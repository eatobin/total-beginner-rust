...
//}
//
//fn find_borrower<'a>(name: &str, brs: Vec<&'a Borrower>) -> Option<&'a Borrower> {
//    let mut iterator = brs.into_iter();
//    let maybe_borrower = iterator.find(|br| br.get_name() == name);
//    maybe_borrower
//}
//
//
...
//        let actual_ptr = find_borrower("Borrower1", brs.clone());
